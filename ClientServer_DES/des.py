...
#     binary_number = bin(int(hex_str, 16))[2:]

#     # Pad with leading zeros to make it a multiple of 8
#     binary_number = binary_number.zfill(len(binary_number) + (8 - len(binary_number) % 8) % 8)
